...
import {faPlayCircle,faGreaterThan,faLessThan} from '@fortawesome/free-solid-svg-icons'
                ...
                <Fragment>
                    <Container className="text-center carouselMarginUp">
                        ...
                        <Slider ref={c => (this.slider = c)} {...settings}>
                            <div className="mt-5 ">
                                <Row>
                                    <Col lg={4} sm={12} md={4} className="mr-5">
                                        <Card style={{ width: '18rem' }} className="carouselCard">
                                            <Card.Img variant="top" src="https://react.rabbil.com/images/class1.svg" />
                                            <Card.Body>
                                                <Card.Title> <FontAwesomeIcon onClick={this.modalSHow} className="carouselBtn" icon={faPlayCircle} /></Card.Title>
                                                <Card.Text>
                    ...
                    <div style={{ textAlign: "center" }} className="mt-5">
                        <Button className="button m-2" variant="dark" size="md" onClick={this.previous}>
                            <FontAwesomeIcon className="carouselItemBtn" icon={faGreaterThan} />
                        </Button>
                        <Button className="button" variant="dark" size="md" onClick={this.next}>
